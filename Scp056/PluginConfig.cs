...
namespace Scp056
{
    public class PluginConfig : AbstractConfigSection
    {
        ...
        public SerializedMapPoint Scp056SpawnPoint { get; set; } = new SerializedMapPoint("HCZ_Room3ar", -1.792f, 1.330017f, -0.004005589f);
        ...
        public float SpawnChanche { get; set; } = 50;
